...
with open("models/encoders_p50.pkl", "rb") as f:
    encoders = pickle.load(f)

with open("models/date_mins_p50.pkl", "rb") as f:
    date_mins = pickle.load(f)

with open("models/feature_config_p50.pkl", "rb") as f:
...
bst_50 = xgb.Booster()
bst_50.load_model("models/model_p50.json")

bst_90 = xgb.Booster()
bst_90.load_model("models/model_p90.json")
...
X_test = tab_matrix_test

# ------------------------------
# XGBoost prediction
dtest = xgb.DMatrix(X_test)
pred_p50 = bst_50.predict(dtest)
pred_p90 = bst_90.predict(dtest)


production = 0.7 * pred_p50 + 0.3 * pred_p90
...
df_pred = pd.DataFrame({
    ...
    "Production": production  # full-season demand estimate
})
